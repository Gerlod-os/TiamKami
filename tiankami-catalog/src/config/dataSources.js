...
// gid листа с играми (0 = первый лист таблицы)
...
// URL для Sheets API (достаём формулы гиперссылок)
export const SHEETS_API_VALUES_URL = (range) =>
  `https://sheets.googleapis.com/v4/spreadsheets/${SPREADSHEET_ID}/values/${encodeURIComponent(range)}?key=${SHEETS_API_KEY}&valueRenderOption=FORMULA`;
